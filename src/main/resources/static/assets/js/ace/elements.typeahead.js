  ...
  * ================================= */
  ...
  , select: function () {
      ...
      if(id != 'undefined' && id != null){
    	  $.each(this.base_source , function(index , value){
    		  if(value.id == id){
    			  data = value;
    			  return false;
    		  }
  ...
  , matcher: function (item) {
      return (typeof(this.base_source) != 'undefined' && typeof(this.base_source) != null )  ||  ~item.toLowerCase().indexOf(this.query.toLowerCase())
    }
  ...
  , render: function (items) {
      ...
      items = $(items).map(function (i, item) {
        ...
        if(that.base_source != 'undefined' && that.base_source != null){
        	i.attr('data-id',that.base_source[index].id);
        }
